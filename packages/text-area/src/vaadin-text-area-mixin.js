...
import { TextAreaController } from '@vaadin/field-base/src/text-area-controller';
import { css } from '@vaadin/vaadin-themable-mixin/vaadin-themable-mixin.js';

/**
 * A mixin providing common textarea functionality.
 *
 * @polymerMixin
...
export const TextAreaMixin = (superClass) =>
  class TextAreaMixinMixinClass extends PatternMixin(InputFieldMixin(ResizeMixin(superClass))) {
    static get styles() {
      return css`
        ${fieldShared}
        ${inputFieldContainer}
